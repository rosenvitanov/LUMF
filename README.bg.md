...
За да се запознаете с концепцията и да направите своите първи стъпки с формата, започнете от **[Ръководството за бърз старт (Getting Started)](docs/getting_started.bg.md)**.
